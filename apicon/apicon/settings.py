"""
Django settings for apicon project.
...
SECRET_KEY = 'django-insecure-&3yhh6e-9*g9o5v#(#vf5zho%@kd5s_i#&c2t6^y)&jg391!ap'
...
WSGI_APPLICATION = 'apicon.wsgi.application'
